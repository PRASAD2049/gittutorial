var scrollElement = function(t, i, e) {
    this.scrollingElement = t, this.origOffset = t.parent().offset().top - 121, this.currentPos = t.position().top, this.height = t.outerHeight(!0), this.width = t.parent().width(), this.top = t.offset().top, this.bottom = Math.ceil(t.offset().top + t.outerHeight(!0)), this.container = {
        element: i,
...
scrollElement.prototype.init = function() {
    ...
    this.scrollingElement.css({
        ...
        top: i,
        bottom: e
    }), o ? this.scrollingElement.css({
        width: o + "px"
    }) : this.scrollingElement.css({
        width: "auto"
    })
}, scrollElement.prototype.update = function() {
    var t = this.scrollingElement,
        i = this.container.element;
